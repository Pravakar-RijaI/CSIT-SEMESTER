    ...
    if (x*x + y*y <= 1) // checks whether the points lie within the circle
	 {
      ...
      putpixel(300 + x * 200, 300 + y * 200, GREEN); // point is drawn in yellow if it falls inside the circle and blue otherwise
     }
    else
      {
putpixel(300 + x * 200, 300 + y * 200, RED); //x&y coordinates of the point are scaled by a factor of 200 and added to 300 
